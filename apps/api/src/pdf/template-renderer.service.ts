  ...
  private registerHelpers(): void {
    ...
    Handlebars.registerHelper('translateLang', function (...args: unknown[]) {
      ...
      if (
        ...
        normalized === 'portugiesisch' ||
        normalized === 'portugais' ||
        normalized === 'portugués' ||
        normalized === 'portoghese'
      ) {
        key = 'lang.portuguese';
      } else if (
        normalized === 'russian' ||
        ...
        normalized === 'japanese' ||
        normalized === 'japanisch' ||
        normalized === 'japonais' ||
        normalized === 'japonés' ||
        normalized === 'giapponese'
      ) {
        key = 'lang.japanese';
      } else if (
        normalized === 'arabic' ||
        ...
        normalized === 'dutch' ||
        normalized === 'niederländisch' ||
        normalized === 'néerlandais' ||
        normalized === 'neerlandés' ||
        normalized === 'olandese'
      ) {
        key = 'lang.dutch';
      } else if (
        ...
        normalized === 'norwegisch' ||
        normalized === 'norvégien' ||
        normalized === 'noruego' ||
        normalized === 'norvegese'
      ) {
        key = 'lang.norwegian';
      } else if (
        normalized === 'danish' ||
        ...
        normalized === 'finnisch' ||
        normalized === 'finnois' ||
        normalized === 'finlandés' ||
        normalized === 'finlandese'
      ) {
        key = 'lang.finnish';
      } else if (
        normalized === 'greek' ||
        normalized === 'griechisch' ||
        normalized === 'grec' ||
        normalized === 'griego' ||
        normalized === 'greco'
      ) {
        ...
        normalized === 'ungarisch' ||
        normalized === 'hongrois' ||
        normalized === 'húngaro' ||
        normalized === 'ungherese'
      ) {
        key = 'lang.hungarian';
      } else if (
        normalized === 'romanian' ||
        normalized === 'rumänisch' ||
        normalized === 'roumain' ||
        normalized === 'rumano' ||
        normalized === 'rumeno'
      ) {
        ...
        normalized === 'mazedonisch' ||
        normalized === 'macédonien' ||
        normalized === 'macedonio' ||
        normalized === 'macedone'
      ) {
        key = 'lang.macedonian';
      } else if (
        normalized === 'slovenian' ||
        normalized === 'slowenisch' ||
        normalized === 'slovène' ||
        normalized === 'esloveno' ||
        normalized === 'sloveno'
      ) {
        ...
        normalized === 'ukrainien' ||
        normalized === 'ucraniano' ||
        normalized === 'ucraino'
      ) {
        key = 'lang.ukrainian';
      } else if (
        normalized === 'korean' ||
        normalized === 'koreanisch' ||
        normalized === 'coréen' ||
        normalized === 'coreano'
      ) {
        key = 'lang.korean';
