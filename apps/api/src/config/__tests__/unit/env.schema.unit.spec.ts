...
describe('JWT Secret Validation', () => {
  ...
  it('should reject JWT_SECRET shorter than 64 characters', () => {
    ...
    expect(() => validateEnv(process.env)).toThrow('JWT_SECRET must be at least 64 characters');
  });
  ...
  it('should reject JWT_SECRET containing "change"', () => {
    ...
    expect(() => validateEnv(process.env)).toThrow('JWT_SECRET cannot contain placeholder text');
  });
