...
describe('JWT Secret Validation', () => {
  ...
  it('should reject JWT_SECRET containing "change"', () => {
    process.env.JWT_SECRET = 'change_me_to_a_strong_secret_minimum_64_characters_long_for_production';
    
    expect(() => validateEnv()).toThrow('JWT_SECRET cannot contain placeholder text');
  });

  it('should reject JWT_SECRET containing "REPLACE"', () => {
    process.env.JWT_SECRET = 'REPLACE_WITH_SECURE_RANDOM_SECRET_MINIMUM_64_CHARACTERS_USE_OPENSSL_RAND_BASE64_64';
  ...
  it('should accept JWT_SECRET with 64+ characters and no placeholders', () => {
    ...
    process.env.JWT_SECRET = 'sXeS4t0WUUSGWSNF39j81hVFFpaCX3xgWco3a2Sb+ClEvHlcmxd//0IUlLdAAxza3cNkxoci8UuFtyVxeLONkg==';
